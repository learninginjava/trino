        ...
        implements RecordCursor
{
    ...
    private void processStringValues(List<String> currentKeys)
    {
        for (int i = 0; i < currentKeys.size(); i++) {
            ...
            processNextRowValues(keyString, valueString, null);
        }
    }
    ...
    private void processHashValues(List<String> currentKeys)
    {
        for (int i = 0; i < currentKeys.size(); i++) {
            ...
            processNextRowValues(keyString, EMPTY_STRING, hashValueMap);
        }
    }

    private void processNextRowValues(String keyString, String valueString, @Nullable Map<String, String> hashValueMap)
    {
